    ...
    : QSyntaxHighlighter (parent)
{
    ...
    // IPv4 format
    ipv4Format.setForeground(Qt::darkGreen);
    ipv4Format.setFontWeight(QFont::Bold);
    ...
    rule.format = ipv4Format;
    highlightingRules.append(rule);

    // IPv6 format
    ipv6Format.setForeground(Qt::darkGreen);
    ipv6Format.setFontWeight(QFont::Bold);
